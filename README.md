...
app/src/main/java/com/spottio/[cite: 1]
│
├── AdminReportsActivity.kt[cite: 1]
├── BaseUserListFragment.kt[cite: 1]
├── DebouncingTextWatcher.kt[cite: 1]
├── DeviceInfoHelper.kt[cite: 1]
├── FileExportHelper.kt[cite: 1]
├── GenericViewModelFactory.kt[cite: 1]
├── GroupAdapter.kt[cite: 1]
├── GroupInfo.kt[cite: 1]
├── GroupMemberAdapter.kt[cite: 1]
├── GroupSettingsActivity.kt[cite: 1]
├── HomeActivity.kt[cite: 1]
├── HomeFragment.kt[cite: 1]
├── HomeViewModel.kt[cite: 1]
├── HtmlExportGenerator.kt[cite: 1]
├── InfoActivity.kt[cite: 1]
├── InteractionTracker.kt[cite: 1]
├── LanguageHelper.kt[cite: 1]
├── LanguageSelectorManager.kt[cite: 1]
├── LoginUIHelper.kt[cite: 1]
├── MainActivity.kt[cite: 1]
├── NonScrollListView.kt[cite: 1]
├── NotificationHelper.kt[cite: 1]
├── Report.kt[cite: 1]
├── ReportAdapter.kt[cite: 1]
├── SplashActivity.kt[cite: 1]
├── User.kt[cite: 1]
├── UserAdapter.kt[cite: 1]
├── UserCache.kt[cite: 1]
├── UserConnectionsFragment.kt[cite: 1]
├── UserGraphicsHelper.kt[cite: 1]
├── UserRepository.kt[cite: 1]
├── UserVerificationManager.kt[cite: 1]
│
├── auth/[cite: 1]
│   └── AuthManager.kt[cite: 1]
│
├── chat/[cite: 1]
│   ├── ChatAdapter.kt[cite: 1]
│   ├── ChatBackgroundHelper.kt[cite: 1]
│   ├── ChatFragment.kt[cite: 1]
│   ├── ChatModels.kt[cite: 1]
│   ├── ChatPreview.kt[cite: 1]
│   ├── ChatPreviewAdapter.kt[cite: 1]
│   ├── ChatRepository.kt[cite: 1]
│   ├── ChatViewModel.kt[cite: 1]
│   ├── MessageUsersFragment.kt[cite: 1]
│   └── MessagesDialogHelper.kt[cite: 1]
│
├── posts/[cite: 1]
│   ├── AddPostFragment.kt[cite: 1]
│   ├── Comment.kt[cite: 1]
│   ├── CommentAdapter.kt[cite: 1]
│   ├── Post.kt[cite: 1]
│   ├── PostAdapter.kt[cite: 1]
│   ├── PostDialogHelper.kt[cite: 1]
│   ├── PostRepository.kt[cite: 1]
│   └── PostViewHolder.kt[cite: 1]
│
├── profile/[cite: 1]
│   ├── ProfileCoordinator.kt[cite: 1]
│   ├── ProfileFragment.kt[cite: 1]
│   ├── ProfileImageHandler.kt[cite: 1]
│   ├── ProfileUIManager.kt[cite: 1]
│   ├── ProfileViewBinder.kt[cite: 1]
│   └── ProfileViewModel.kt[cite: 1]
│
├── settings/[cite: 1]
│   ├── SettingsAdapter.kt[cite: 1]
│   ├── SettingsAuthManager.kt[cite: 1]
│   ├── SettingsExportManager.kt[cite: 1]
│   ├── SettingsFragment.kt[cite: 1]
│   ├── SettingsMenuProvider.kt[cite: 1]
│   └── SettingsPrivacyManager.kt[cite: 1]
│
└── users/[cite: 1]
    ├── SearchUsersFragment.kt[cite: 1]
    └── SearchUsersViewModel.kt[cite: 1]
