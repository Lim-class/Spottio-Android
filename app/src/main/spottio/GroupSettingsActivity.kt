...
class GroupSettingsActivity : AppCompatActivity() {
    ...
    override fun onCreate(savedInstanceState: Bundle?) {
        ...
        // MODIFICA QUI: Rimosso il parametro 'db' per allinearlo al nuovo GroupMemberAdapter
        memberAdapter = GroupMemberAdapter(this, memberIds, currentUser!!, groupId!!, listener)
