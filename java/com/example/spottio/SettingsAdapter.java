...
public class SettingsAdapter extends RecyclerView.Adapter<SettingsAdapter.SettingsViewHolder> {
    ...
    public SettingsViewHolder onCreateViewHolder(@NonNull ViewGroup parent, int viewType) {
        View view = LayoutInflater.from(parent.getContext()).inflate(R.layout.item_setting_accordion, parent, false);
        return new SettingsViewHolder(view);
    }

    @Override
    public void onBindViewHolder(@NonNull SettingsViewHolder holder, int position) {
        SettingItem item = filteredList.get(position);
        ...
        switch (item.type) {
            case PASSWORD:
                innerLayoutRes = R.layout.layout_inner_password;
                break;
            case CAMBIO_EMAIL:
                innerLayoutRes = R.layout.layout_inner_cambio_email;
                break;
            case PRIVACY_PROFILO:
                innerLayoutRes = R.layout.layout_inner_privacy_profilo;
                break;
            case ESPORTA_DATI:
                innerLayoutRes = R.layout.layout_inner_esporta_dati;
                break;
            default:
                innerLayoutRes = R.layout.layout_inner_info;
                break;
        }

        View innerView = LayoutInflater.from(holder.itemView.getContext()).inflate(innerLayoutRes, holder.layoutContent, false);
    ...
    public void filter(String text) {
        ...
        if (text.isEmpty()) {
            ...
            for (SettingItem item : originalList) {
