...
public class GroupSettingsActivity extends AppCompatActivity {
    ...
    protected void onCreate(@Nullable Bundle savedInstanceState) {
        ...
        memberAdapter = new GroupMemberAdapter(this, memberIds, currentUser, db, groupId);
        lvGroupMembers.setAdapter(memberAdapter);

        loadGroupData();

        // NOTA: Qui ora usiamo "name" invece di "groupName"
    ...
    private void loadGroupData() {
        db.collection("groups").document(groupId).addSnapshotListener((snapshot, error) -> {
            ...
            // CORREZIONE APPLICATA QUI: usiamo i nomi dei campi esatti mostrati nello screenshot
    ...
    private void showEditDialog(String titolo, String fieldName, String testoAttuale) {
        ...
        new AlertDialog.Builder(this)
                ...
                .setPositiveButton("Salva", (dialog, which) -> {
                    ...
                    if (fieldName.equals("name")) { // CORREZIONE: Aggiornato anche qui
        ...
        new AlertDialog.Builder(this)
                ...
                .setPositiveButton("Esci", (dialog, which) -> {
                    if (isAdmin && memberIds.size() > 1) {
                        ...
                        // CORREZIONE: Passaggio di ruolo usa "createdBy"
