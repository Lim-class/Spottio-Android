...
public class UserCache {
    ...
    // FIX MEMORY LEAK: Sostituita la HashMap con una LruCache (tiene in memoria massimo 100 utenti)
    private static final LruCache<String, UserData> cache = new LruCache<>(100);
